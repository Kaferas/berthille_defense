        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12">
                <div class="bg-secondary rounded h-100 p-4">
                    <h3 class="mb-4">Modifier Cours</h3>
                        ...
                        <div class="row">
                            <div class="mb-3 col-6">
                                ...
                                <input type="text" class="form-control border-light" id="name_cours" name="name_cours"
                                    aria-describedby="emailHelp" value="{{ @old('name_cours') ?? $cours->name_cours }}">
                            ...
                            <div class="mb-3 col-6">
                                ...
                                <input type="number" class="form-control border-light" id="hours_cours" name="hours_cours"
                                    aria-describedby="emailHelp" value="{{ @old('hours_cours') ?? $cours->hours_cours }}">
                                <div id="emailHelp" class="form-text mt-3">
                                    @error('hours_cours')
                                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="mb-3 col-12">
                                ...
                                <textarea name="description_cours" id="description_cours" cols="30" rows="8"
                                    ...
                                    {{ @old('description_cours') ?? $cours->description_cours }}
                                </textarea>
                                <div id="emailHelp" class="form-text mt-3">
                            ...
                            <div class="col-6">
                                <button type="submit" class="btn btn-primary">Modifier Cours</button>
                            </div>
                    </form>
                </div>
            </div>
